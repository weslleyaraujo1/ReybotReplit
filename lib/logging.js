...
module.exports = (type, info, message) => {
  ...
  switch (type) {
    case "primary":
      console.log(
        `\n\x1b[1m\x1b[44m Reybot ヅ \x1b[0m\x20\x20${time}`,
    ...
    case "error":
      console.log(
        `\n\x1b[1m\x1b[41m Reybot ヅ \x1b[0m\x20\x20${time}`,
    ...
    case "warning":
      console.log(
        `\n\x1b[1m\x1b[43m Reybot ヅ \x1b[0m\x20\x20${time}`,
    ...
    case "success":
      console.log(
        `\n\x1b[1m\x1b[42m Reybot ヅ \x1b[0m\x20\x20${time}`,
    ...
    case "info":
      console.log(
        `\n\x1b[1m\x1b[46m Reybot ヅ \x1b[0m\x20\x20${time}`,
    ...
    default:
      console.log(
        `\n\x1b[1m\x1b[45m Reybot ヅ \x1b[0m\x20\x20${time}`,
